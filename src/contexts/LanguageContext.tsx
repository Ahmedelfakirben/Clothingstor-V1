...
const translations = {
  es: {
    ...
    'stock.available_items': 'Productos en Stock (>0)',
    'stock.available_products': 'Productos Disponibles',
    'stock.in_stock': 'Productos en Stock',
    'stock.units': 'unidades',
    'stock.total_sold_units': 'Total Unidades Vendidas',
    'stock.sold': 'vendidas',
    'stock.catalog_view': 'Ver Catálogo',
    'stock.status_active': 'Productos Activos',
    'stock.status_all': 'Todos los Registrados',
    'stock.status_deleted': 'Productos Eliminados',
    'stock.status_stock': 'Estado Stock',
    'stock.deleted': 'Eliminado',
    'stock.all_statuses': 'Todos los Estados',
    'stock.total_units_sub': 'unidades en total',
    ...
    'Resta': 'Resta',
    'orders.partial_payment': 'Pago Parcial',
    'orders.pending_payment': 'Pendiente de Pago',
    'Completar Pago': 'Completar Pago',
    'Completar Pago Restante': 'Completar Pago Restante',
    'Orden completada y pagada exitosamente': 'Orden completada y pagada exitosamente',
    ...
    'Todas las tallas': 'Todas las tallas',
    ...
    'pos.sale_channel': 'Canal de Venta',
    'pos.channel_store': 'Tienda',
    'pos.channel_website': 'Web',
    'pos.sizes': 'Tallas',
    'pos.price': 'Precio',
    'pos.photos': 'Fotos',
    'Canal': 'Canal',
    ...
    'analytics.cogs': 'Costo (Productos):',
    ...
    'analytics.real_profit': 'Beneficio Real (Últimos 7 días)',
    'analytics.profit_margin_desc': 'Beneficio neto tras restar coste de compra',
    'analytics.sales_by_channel': 'Ventas por Canal',
    'analytics.channel_comparison': 'Comparativa Tienda vs Web (30d)',
    ...
    'analytics.sales_evolution': 'Evolución de Ventas',
    'analytics.revenue_7_days': 'Facturación de los últimos 7 días',
    'analytics.payment_methods': 'Métodos de Pago',
    'analytics.income_distribution': 'Distribución de ingresos',
    'analytics.category_sales': 'Ventas por Categoría',
    'analytics.category_comparison': 'Comparativa de ingresos por tipo de producto',
    'analytics.revenue': 'Ingresos',
    'analytics.others': 'Otros',
    'analytics.registered_customers': 'Clientes registrados',
    'analytics.current_time': 'Hora actual',
    'analytics.net_profit': 'Ganancia',
    ...
    'products.promo_active': 'Promoción Activa',
    'products.promo_price': 'Precio Promoción',
    'products.invalid_promo_price': 'El precio de promoción debe ser menor al precio base',
  ...
  fr: {
    ...
    'stock.validate_changes': 'Valider les Changements',
    ...
    'stock.available_items': 'Produits en Stock (>0)',
    'stock.available_products': 'Produits Disponibles',
    'stock.in_stock': 'Produits en Stock',
    'stock.units': 'unités',
    'stock.total_sold_units': 'Total Unités Vendues',
    'stock.sold': 'vendues',
    'stock.catalog_view': 'Voir Catalogue',
    'stock.status_active': 'Produits Actifs',
    'stock.status_all': 'Tous les Enregistrés',
    'stock.status_deleted': 'Produits Supprimés',
    'stock.status_stock': 'État du Stock',
    'stock.deleted': 'Supprimé',
    'stock.all_statuses': 'Tous les États',
    'stock.total_units_sub': 'unités au total',
    ...
    'Debe asignar un cliente para realizar un pago anticipado o parcial': 'Vous devez assigner un client pour effectuer un paiement anticipé ou partiel',
    'Asigne un cliente para permitir pagos parciales o anticipos.': 'Assignez un client pour permettre des paiements partiels ou des acomptes.',
    'Seleccionar Talla': 'Sélectionner la Taille',
    'pos.total_order': 'Total de la commande',
    'pos.view_cart_details': 'Voir le Panier Détaillé',
    'pos.items': 'Articles',
    ...
    // Orders Dashboard
    'Panel de Órdenes': 'Tableau de Commandes',
    ...
    'Pagado': 'Payé',
    'Resta': 'Reste',
    'orders.partial_payment': 'Paiement Partiel',
    'orders.pending_payment': 'En Attente de Paiement',
    'Completar Pago': 'Compléter le Paiement',
    'Completar Pago Restante': 'Compléter le Solde',
    'Orden completada y pagada exitosamente': 'Commande complétée et payée avec succès',
    ...
    'Cancelada': 'Annulée',
    'Seleccionar Método de Pago para Completar': 'Sélectionner le Mode de Paiement pour Compléter',
    'Completar Orden': 'Compléter la Commande',
    'Confirmar Eliminación': 'Confirmer la Suppression',
    'Esta acción no se puede deshacer. El pedido se moverá a órdenes eliminadas.': 'Cette action est irréversible. La commande sera déplacée vers les commandes supprimées.',
    ...
    'Error al actualizar el estado': 'Erreur lors de la mise à jour de l\'état',
    'Orden completada exitosamente': 'Commande complétée avec succès',
    ...
    'Todas las tallas': 'Toutes les tailles',
    ...
    'Beneficio:': 'Bénéfice :',
    'Margen:': 'Marge :',
    'Bénéfice Réel (7 derniers jours)': 'Bénéfice Réel (7 derniers jours)',
    'Bénéfice net après déduction du coût d\'achat': 'Bénéfice net après déduction du coût d\'achat',
    'Ventes par Canal': 'Ventes par Canal',
    'Comparaison Boutique vs Web (30j)': 'Comparaison Boutique vs Web (30j)',
    ...
    'pos.sale_channel': 'Canal de Vente',
    'pos.channel_store': 'Boutique',
    'pos.channel_website': 'Site Web',
    'pos.sizes': 'Tailles',
    'pos.price': 'Prix',
    'pos.photos': 'Photos',
    'Canal': 'Canal',
    ...
    'Nombre (A-Z)': 'Nom (A-Z)',
    'Nombre (Z-A)': 'Nom (Z-A)',
    'products.promo_active': 'Promotion Active',
    'products.promo_price': 'Prix Promotionnel',
    'products.invalid_promo_price': 'Le prix promotionnel doit être inférieur au prix de base',
